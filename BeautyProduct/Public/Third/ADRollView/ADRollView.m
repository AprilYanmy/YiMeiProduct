...
- (void)createCurrentView
{
    ...
    self.currentBtn.frame = CGRectMake(0, (self.currentView.frame.size.height-35)/2, 0, 35);
    [self.currentBtn setTitle:model.noticeType forState:UIControlStateNormal];
...
//    }];
    ...
    self.currentLabel.textColor = ColorMainBG;//[UIColor colorWithHexString:@"666666" alpha:1.0];
...
- (void)createHidenView
{
    ...
    self.hidenBtn.frame = CGRectMake(0, (self.currentView.frame.size.height-35)/2, 0, 35);
    ...
    self.hidenTimeLabel.textColor = ColorMainBG;//[UIColor colorWithHexString:@"666666" alpha:1.0];
...
//    }];
    ...
    self.hidenLabel.textColor = ColorMainBG;// [UIColor colorWithHexString:@"666666" alpha:1.0];
