...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *righttem=[[UIBarButtonItem alloc] initWithTitle:@"确定" style:UIBarButtonItemStylePlain target:self action:@selector(doneClick)];
...
- (void)showInView:(UIView *) view
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, view.frame.size.height - self.frame.size.height-60, self.frame.size.width, self.frame.size.height);
    }];
